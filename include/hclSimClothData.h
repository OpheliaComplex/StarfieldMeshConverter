...
namespace hktypes {
	...
	public:
		...
		public:
			using BaseType = void;
			std::array<hkVector4, 4> frameVector; // Offset: 0
			std::array<hkReal, 4> weight; // Offset: 64
			std::array<hkUint16, 4> particleIndex; // Offset: 80
		...
		public:
			using BaseType = void;
			std::array<hkVector4, 4> frameVector; // Offset: 0
			std::array<hkReal, 4> stiffness; // Offset: 64
			std::array<hkUint16, 4> particleIndex; // Offset: 80
		...
		std::vector<hclVolumeConstraintMx::FrameBatchData> frameBatchDatas; // Offset: 40
		std::vector<hclVolumeConstraintMx::ApplyBatchData> applyBatchDatas; // Offset: 56
